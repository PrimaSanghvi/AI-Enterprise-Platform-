    ...
    <div className="p-6 space-y-6 max-h-screen overflow-y-auto">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <p className="text-2xl font-bold text-gray-900 mt-1">{stats.document_count}</p>
          <p className="text-xs text-gray-400 mt-0.5">source files</p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <p className="text-xs text-gray-500 font-medium">Total Chunks</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">{stats.vector_count}</p>
          <p className="text-xs text-gray-400 mt-0.5">indexed vectors</p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <p className="text-xs text-gray-500 font-medium">Vector Dimensions</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">{config.vector_dimensions}</p>
          <p className="text-xs text-gray-400 mt-0.5">TF-IDF features</p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <p className="text-xs text-gray-500 font-medium">Search Blend</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">
            {Math.round(config.vector_weight * 100)}/{Math.round(config.keyword_weight * 100)}
          </p>
          <p className="text-xs text-gray-400 mt-0.5">vector / keyword</p>
        </div>
      </div>
                    ...
                    <td className="px-4 py-2">
                      <span
                        className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${
                          sectorColors[doc.sector] || "bg-gray-100 text-gray-600"
                        }`}
                      >
                        {doc.sector}
                      </span>
